...
Original file is located at
    https://colab.research.google.com/drive/1A3ASPHJXQ0xQBQI-CK3EUe1PSQb1692l
"""
...
import os
os.environ["IMDS_USERNAME"] = "jowk0001"
os.environ["IMDS_PASSWORD"] = "ROCky5929#@!123"
os.environ["IMDS_INBOX_URL"] = "https://www.mdsystem.com/imdsnt/faces/sentReceivedSearch"
# Optional email settings
os.environ["GMAIL_SENDER_EMAIL"] = "kamyuen.wong@johnsonelectric.com"
os.environ["GMAIL_APP_PASSWORD"] = "M5UF ARDE NVCT C6LN IYYG CR2R KA4W IRJU"  # remove spaces

# Commented out IPython magic to ensure Python compatibility.
# %%writefile imds_agent_v2.py
# #!/usr/bin/env python3
# """
...
# 
# # ---------- Configuration ----------
# IMDS_USERNAME = os.getenv("IMDS_USERNAME", "jowk0001")
# IMDS_PASSWORD = os.getenv("IMDS_PASSWORD", "ROCky5929#@!123")
# OTP_SECRET = os.getenv("OTP_SECRET", "M5UF ARDE NVCT C6LN IYYG CR2R KA4W IRJU")
# OUTPUT_DIR = "./imds_output"
# NUM_ITERATIONS = 3
# RECIPIENT_IDS = os.getenv("RECIPIENT_COMPANY_IDS", "9994,293798").split(",")
...
#             page.screenshot(path=Path(OUTPUT_DIR) / "error.png")
#         finally:
#             browser.close()
# 
